...
## **STEP 1: UPDATE BRAIN SHEET**

### **A. Add Rush_Production Column:**

1. Go to BRAIN sheet
2. Click column **AC** (after Delivered_On)
3. Right-click > Insert 1 column left
4. Name it: **Rush_Production**
5. Select cells AC2:AC1000
6. Data > Data validation > Criteria: Checkbox
7. Save

### **B. Verify Column Structure:**

Your BRAIN should now have **35 columns (A-AI)**:
- A-AB: Same as before
- **AC: Rush_Production** (NEW!)
- AD-AI: Notes, Trigger_Email, Email_Stage, Last_Email_Sent, Form_Timestamp, Last_Synced

---

## **STEP 2: UPDATE APPS SCRIPT**

### **A. Update SQUARE WEBHOOK.gs:**

1. Open Apps Script
2. Open **SQUARE WEBHOOK.gs**
3. **Replace entire file** with the code from Part 2
4. Save (Ctrl+S)

### **B. Update CODE.gs:**

1. Open **CODE.gs**
2. **Add all the new functions** from Part 3 (don't delete existing functions!)
3. Save (Ctrl+S)

### **C. Redeploy Webhook:**

1. Click **Deploy** > **Manage deployments**
2. Click **✏️ Edit** on your web app
3. **New description:** "Full automation - payment + fulfillment"
4. Click **Deploy**
5. Copy the URL (should be same as before)

### **D. Update Square Webhook Events:**

1. Go to Square Developer Dashboard
2. Find your webhook
3. **Add event:** `order.fulfillment.updated`
4. Save (you should now have TWO events):
   - `payment.created` ✅
...
### **A. Create Portal Files:**

1. Create folder: **dopelee-client-portal**
2. Create these 3 files in the folder:
   - **index.html** (code from Part 4, File 1)
   - **style.css** (code from Part 4, File 2)
   - **portal.js** (code from Part 4, File 3)

### **B. Deploy to Netlify:**

1. Go to **app.netlify.com**
2. Drag the **dopelee-client-portal** folder onto deploy area
